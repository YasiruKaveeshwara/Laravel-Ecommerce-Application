								...
								<table className='w-full border-separate border-spacing-y-3 text-sm text-slate-600'>
									<thead className='text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500'>
										<tr>
											...
											<th className='px-5 py-2 text-left'>Placed</th>
										...
										{loading && orders.length > 0 ? (
											...
											orders.map((order) => (
												<tr
													...
													<td className='px-5 py-4 align-middle font-semibold text-slate-900 first:rounded-l-3xl'>
													...
													<td className='px-5 py-4 align-middle text-right'>
														<Button
															asChild
															variant='ghost'
															className='inline-flex items-center rounded-full border border-sky-200 px-4 py-2 text-sm font-semibold text-sky-700 transition hover:-translate-y-0.5 hover:bg-sky-50'>
