...
import { ArrowUpRight, Loader2, Package, RefreshCcw, Sparkles, TicketPercent } from "lucide-react";
...
export default function OrdersPage() {
  ...
  const loadOrders = useCallback(async () => {
    ...
    try {
      ...
      const message = error?.message || "Unable to load orders right now.";
  ...
  if (!initialized) {
    return (
      <div className='mx-auto flex max-w-3xl items-center justify-center gap-3 px-4 py-24 text-muted'>
